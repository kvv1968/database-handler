...
import ru.platform.learning.databasehandler.repository.LogFileRepository;
...
public class LogFileService {
    ...
    public List<LogFile> getExpiredDate(Date date) {
        if (date == null){
            final String msg = "Error Date is null";
            log.error(msg);
            throw new IllegalArgumentException(msg);
        }
        return fileRepository.findAllByExpiredDateLessThan(date);
    }
}
